                                ...
                                <div class="col-12 col-md-8">
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="products-subtitle">{{ $transaction->transaction->user->name }}</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="products-title">Product Name</div>
                                            <div class="products-subtitle">{{ $transaction->product->name }}</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="products-title">Date of Transaction</div>
                                            <div class="products-subtitle">{{ $transaction->created_at }}</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="products-title">Payment Status</div>
                                            <div class="products-subtitle text-danger">{{ $transaction->transaction->transaction_status }}</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="products-title">Total Amount</div>
                                            <div class="products-subtitle">Rp {{ number_format($transaction->transaction->total_price) }}</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="products-title">Mobile</div>
                                            <div class="products-subtitle">{{ $transaction->transaction->user->phone_number }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="products-subtitle">{{ $transaction->transaction->user->address_one }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="products-title">Address II</div>
                                                <div class="products-subtitle">{{ $transaction->transaction->user->address_two }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="products-title">Province</div>
                                                <div class="products-subtitle">{{ App\Models\Province::find($transaction->transaction->user->provinces_id)->name }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="products-title">City</div>
                                                <div class="products-subtitle">{{ App\Models\Regency::find($transaction->transaction->user->regencies_id)->name }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="products-title">Postal Code</div>
                                                <div class="products-subtitle">{{ $transaction->transaction->user->zip_code }}</div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="products-title">Country</div>
                                                <div class="products-subtitle">{{ $transaction->transaction->user->country }}</div>
                                            </div>
