                              ...
                              <div class="row" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="address_one" name="address_one" value="{{ $user->addres_one }}">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label for="zip_conde">Postal Code</label>
                                    <input type="text" class="form-control" id="zip_conde" name="zip_conde" value="{{ $user->zip_code }}">
                                  </div>
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group">
